...
void View::on_btn_right_move_clicked() { Move(-kStep, s21::X); }

void View::on_btn_left_move_clicked() { Move(kStep, s21::X); }

void View::on_btn_down_move_clicked() { Move(-kStep, s21::Y); }

void View::on_btn_up_move_clicked() { Move(kStep, s21::Y); }

void View::on_btn_backward_move_clicked() { Move(-kStep, s21::Z); }

void View::on_btn_forward_move_clicked() { Move(kStep, s21::Z); }

void View::on_btn_down_rotate_clicked() { Rotate(kStep, s21::X); }

void View::on_btn_up_rotate_clicked() { Rotate(-kStep, s21::X); }

void View::on_btn_left_rotate_clicked() { Rotate(kStep, s21::Y); }

void View::on_btn_right_rotate_clicked() { Rotate(-kStep, s21::Y); }

void View::on_btn_clockwise_rotate_clicked() { Rotate(-kStep, s21::Z); }

void View::on_btn_counterlock_rotate_clicked() { Rotate(kStep, s21::Z); }
